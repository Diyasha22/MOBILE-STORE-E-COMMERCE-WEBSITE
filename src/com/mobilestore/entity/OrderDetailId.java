...
//	private static final long serialVersionUID = 1L;
	...
	public OrderDetailId(Integer orderId, Integer mobileId, int quantity, float subtotal) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getOrderId() == castOther.getOrderId()) || (this.getOrderId() != null
				...
				&& ((this.getMobileId() == castOther.getMobileId()) || (this.getMobileId() != null
						&& castOther.getMobileId() != null && this.getMobileId().equals(castOther.getMobileId())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getMobileId() == null ? 0 : this.getMobileId().hashCode());
