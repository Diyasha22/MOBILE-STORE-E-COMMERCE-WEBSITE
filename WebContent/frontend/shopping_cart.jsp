					...
					<table border="1">
						...
						<c:forEach items="${cart.items}" var="item" varStatus="status">
							<tr>
								...
								<td>
									<span id="mobile-model">${item.key.model}</span>
								</td>
								<td>    
									<input type="hidden" name="mobileId" value="${item.key.mobileId}" />
								...
								<td><a href="remove_from_cart?mobile_id=${item.key.mobileId}">Remove</a></td>
							</tr>
						</c:forEach>
